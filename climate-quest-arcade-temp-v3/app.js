...
const QUESTIONS = [
  ...
  { id:"E2", category:"Energy", difficulty:1, type:"single",
    ...
    explain:"LEDs cut lighting energy dramatically across many fixtures, beating tiny 'vampire' loads."
  },
...
async function submitScoreToGoogleForm(st) {
  try {
    ...
    const res = await fetch(CONFIG.GOOGLE_FORM_ACTION, { method: "POST", mode: "no-cors", body: data });
    return true;
  } catch (e) {
    console.error(e);
    return false;
